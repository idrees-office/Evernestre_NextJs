          ...
          <div className="flex justify-center text-center">
            <div className="space-y-5">
              ...
              <ul className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-3 text-[14px] text-[#0e0e0e]/80 max-w-xl mx-auto">
                {["Market Intelligence", "Expert Analysis", "Investment Guides"].map((item) => (
        ...
        <div className="container mx-auto px-4 max-w-8xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            <div className="lg:col-span-8">
              {featuredNews && (
                  <Link href={`/news/${featuredNews.slug}`} className="block mb-12">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {regularNews.map((newsItem, index) => (
                      <Link key={newsItem.id} href={`/news/${newsItem.slug}`} className="block">
                        <motion.article
