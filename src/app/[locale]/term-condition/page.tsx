        ...
        <div className="">
          ...
          <section id="agreement" className="mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                We are <strong>Evernest Real Estate</strong> (
                <strong>Company</strong>, <strong>we</strong>,{" "}
                <strong>us</strong>, or <strong>our</strong>), a company
                registered in the <strong>United Arab Emirates</strong> at{" "}
                <strong>
                  Al zarouni business center - office no 301 & 302, 3rd floor,
                  Dubai, 00000
                </strong>
                .
              </p>
              ...
              <p>
                <strong>
                  Evernest Real Estate is your top choice, offering in-depth
                  market expertise, a wide range of properties and a focus on
                  personalized service to guarantee a smooth real estate
                  journey.
                </strong>
              </p>

              <p>
                You can contact us by phone at <strong>+971527469500</strong>,
                email at <strong>evernestre@gmail.com</strong>, or by mail to{" "}
                <strong>
                  Al zarouni business center - office no 301 & 302, 3rd floor,
          ...
          <section id="ppyes" className="mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                ...
                Privacy Policy:{" "}
                <a
                  href="https://evernest.ae/privacy-policy"
                  className="text-blue-600 hover:underline"
                >
                  https://evernest.ae/privacy-policy
                </a>
          ...
          <section id="law" className="mb-8">
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                ...
                laws of the United Arab Emirates. Evernest Real Estate and
                yourself irrevocably consent that the courts of the United Arab
                Emirates shall have exclusive jurisdiction to resolve any
