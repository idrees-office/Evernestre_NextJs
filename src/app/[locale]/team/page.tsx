          ...
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-light text-[#3c2f26] mb-4">
                {t('commitment_to_excellence_title')} <span className="font-semibold text-[#8b5d3b]">  {t('excellence_highlight')}</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {[
                { title: "expert_advisory_title", desc: "expert_advisory_desc", icon: "🎯" },
                { title: "creative_excellence_title", desc: "creative_excellence_desc", icon: "✨" },
                { title: "technology_driven_title", desc: "technology_driven_desc", icon: "💻" },
                { title: "client_first_title", desc: "client_first_desc", icon: "⭐" },
              ].map((value, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold text-[#3c2f26] mb-3">{ t(``+value.title+``)} </h3>
                  <p className="text-[#3c2f26]/60 text-sm leading-relaxed">{ t(``+value.desc+``)}</p>
                </motion.div>
              ))}
            </div>
          </div>
