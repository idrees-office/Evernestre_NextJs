        ...
        <div className="container mx-auto max-w-7xl px-6 md:px-8 py-12 md:py-16 relative">
          ...
          >
            ...
            {/* <div className="flex flex-wrap gap-4">
              <button className="bg-[#8b5d3b] hover:bg-[#6d4830] text-white px-8 py-6 rounded-full text-base font-normal shadow-lg shadow-[#8b5d3b]/20 transition-all duration-300 hover:shadow-xl hover:shadow-[#8b5d3b]/30">
                Schedule Consultation
                <ArrowRight className="ml-2 h-4 w-4" />
              </button>
              <button className="border-[#c9a882] text-[#8b5d3b] hover:bg-[#c9a882]/10 px-8 py-6 rounded-full text-base font-normal">
