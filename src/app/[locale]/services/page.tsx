...
export default function Services() {
  ...
  const services = [
    {
      icon: Home,
      title: t("Property_Buying"),
      description: t("Property_Buying_Desc"),
      features: [
        t("Property_Buying_Feature_1"),
        t("Property_Buying_Feature_2"),
        t("Property_Buying_Feature_3"),
        t("Property_Buying_Feature_4"),
      ],
    },
    {
      icon: TrendingUp,
      title: t("Offplan_Investment"),
      description: t("Offplan_Investment_Desc"),
      features: [
        t("Offplan_Investment_Feature_1"),
        t("Offplan_Investment_Feature_2"),
        t("Offplan_Investment_Feature_3"),
        t("Offplan_Investment_Feature_4"),
      ],
    },
    {
      icon: Key,
      title: t("Property_Selling"),
      description: t("Property_Selling_Desc"),
      features: [
        t("Property_Selling_Feature_1"),
        t("Property_Selling_Feature_2"),
        t("Property_Selling_Feature_3"),
        t("Property_Selling_Feature_4"),
      ],
    },
    {
      icon: Building2,
      title: t("Property_Management"),
      description: t("Property_Management_Desc"),
      features: [
        t("Property_Management_Feature_1"),
        t("Property_Management_Feature_2"),
        t("Property_Management_Feature_3"),
        t("Property_Management_Feature_4"),
      ],
    },
    {
      icon: FileText,
      title: t("Mortgage_Advisory"),
      description: t("Mortgage_Advisory_Desc"),
      features: [
        t("Mortgage_Advisory_Feature_1"),
        t("Mortgage_Advisory_Feature_2"),
        t("Mortgage_Advisory_Feature_3"),
        t("Mortgage_Advisory_Feature_4"),
      ],
    },
    {
      icon: Users,
      title: t("Investment_Consultation"),
      description: t("Investment_Consultation_Desc"),
      features: [
        t("Investment_Consultation_Feature_1"),
        t("Investment_Consultation_Feature_2"),
        t("Investment_Consultation_Feature_3"),
        t("Investment_Consultation_Feature_4"),
      ],
    },
  ];
  ...
  return (
    <main className="bg-[#f6ecdf] min-h-screen">
      ...
      <section className="relative overflow-hidden">
        <div className="container mx-auto max-w-7xl px-6 md:px-8 py-16">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/60 px-4 py-1.5 text-sm mb-6">
              <Sparkles className="h-4 w-4 text-[#c9a882]" />
              {t("Hero_Badge")}
            </div>

            <h1 className="text-5xl md:text-6xl font-light mb-6">
              {t("Hero_Title_1")}{" "}
              <span className="text-[#8b5d3b]">{t("Hero_Title_2")}</span>
            </h1>
        ...
        <div className="container mx-auto max-w-7xl px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              ...
              >
                <service.icon className="h-6 w-6 text-[#8b5d3b] mb-4" />
                ...
                <ul className="space-y-2">
                  {service.features.map((feature, i) => (
                    <li key={i} className="text-sm flex gap-2">
                      <CheckCircle2 className="h-4 w-4 text-[#c9a882]" />
                      {feature}
                    </li>
                  ))}
                </ul>

                <button className="mt-4 text-[#8b5d3b] flex items-center gap-2">
                  {t("Learn_More")}
                  <ChevronRight className="h-4 w-4" />
                </button>
              </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-7xl px-6 md:px-8 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl mb-6">{t("Why_Choose_Evernest")}</h2>
            <p className="text-[#1a1a1a]/70">{t("Why_Choose_Desc")}</p>
          </div>

          <div className="relative h-[500px] rounded-2xl overflow-hidden">
            <Image
              src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80"
              alt={t("Luxury_Property")}
              fill
