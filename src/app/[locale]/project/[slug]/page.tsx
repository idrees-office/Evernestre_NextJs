  ...
  return (
              ...
              <div className="bg-white rounded-md border border-gray-100 p-4 sm:p-5">
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-1.5 py-2.5 sm:py-3 border border-green-500 rounded-sm text-xs sm:text-sm font-medium text-green-600 hover:bg-green-50 transition-colors active:scale-95"
                  >
                    ...
                    <span className="xs:hidden">{t('whatsapp_short')}</span>
                  </a>
                </div>
              </div>
            </div>
    ...
    <section ref={galleryRef} className="py-6 sm:py-8 bg-[#faf8f5]">
      <div className="container mx-auto px-4 mb-3">
        <div className="flex items-center gap-2">
          <div className="w-1 h-5 bg-[#c97a52] rounded-full"></div>
          <h3 className="text-base sm:text-lg font-medium text-gray-900"> {t('project_gallery')}</h3>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
            ...
            <div className="bg-gradient-to-br from-[#f0ebe4] to-[#e8dfd4] rounded-sm p-5 text-center">
              ...
              <p className="text-[10px] text-gray-500 mt-0.5">{t('award_winning_developer')}</p>
            </div>
          </div>
        </div>
      </section>  
