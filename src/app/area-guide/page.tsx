        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          ...
          {areas.length === 0 ? (
            <div className="text-center py-12 w-full">
              ...
              <p className="text-gray-500">There are currently no areas available.</p>
            </div>
          ) : (
            <>
                    ...
                    <div className="relative rounded-lg bg-white shadow-sm hover:shadow-xl transition-all duration-500 ease-out hover:-translate-y-1 border border-gray-100/80 w-full">
                      ...
                      <div className="relative h-48 sm:h-56 md:h-60 w-full rounded-md">
                        <img
                          ...
                          draggable={false}
                          onError={(e) => { e.currentTarget.src = "https://images.pexels.com/photos/460672/pexels-photo-460672.jpeg?auto=compress&cs=tinysrgb&w=1200";
                          }}
                        />
                ...
                <div className="mt-12 flex items-center justify-center gap-2 w-full">
                  ...
                  {Array.from({ length: pagination.last_page }, (_, i) => i + 1)
                    .filter(pageNum => {
                      ...
                      if (pageNum === 1 || pageNum === pagination.last_page) return true;
                      if (Math.abs(pageNum - pagination.current_page) <= 1) return true;
                      return false;
                    })
