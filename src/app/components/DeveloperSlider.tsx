...
//   developers?: Developer[]; // Make it optional
// }
...
//               className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center transition-all duration-300 border border-[#f0e4d9] ${
//                 canScrollLeft
//                   ? "text-[#c97a52] hover:bg-[#c97a52] hover:text-white hover:scale-110"
...
//               className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center transition-all duration-300 border border-[#f0e4d9] ${
//                 canScrollRight
//                   ? "text-[#c97a52] hover:bg-[#c97a52] hover:text-white hover:scale-110"
//                   : "text-[#8b5d3b]/20 cursor-not-allowed opacity-50"
//               }`}
        ...
        <div className="mx-auto max-w-8xl px-4 sm:px-6 md:px-10">
          <div className="relative">
            ...
            <button 
              onClick={() => scroll("left")} 
              disabled={!canScrollLeft}
              className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 sm:-translate-x-3 md:-translate-x-4 z-10 w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-white shadow-lg flex items-center justify-center transition-all duration-300 border border-[#f0e4d9] ${
                canScrollLeft
                  ? "text-[#c97a52] hover:bg-[#c97a52] hover:text-white hover:scale-110"
                  : "text-[#8b5d3b]/20 cursor-not-allowed opacity-50"
              }`}
            ...
            <button
              onClick={() => scroll("right")}
              disabled={!canScrollRight}
              className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 sm:translate-x-3 md:translate-x-4 z-10 w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-white shadow-lg flex items-center justify-center transition-all duration-300 border border-[#f0e4d9] ${
                canScrollRight
                  ? "text-[#c97a52] hover:bg-[#c97a52] hover:text-white hover:scale-110"
                  : "text-[#8b5d3b]/20 cursor-not-allowed opacity-50"
              }`}
