...
const STATS: Stat[] = [
  { value: 500, label: "successfulDeals", suffix: "+", abbrK: false },
  { value: 550, label: "satisfiedClients", suffix: "+", abbrK: false },
  { value: 2000, label: "managedProperties", suffix: "+", abbrK: true }, // Changed from duplicate
  { value: 30, label: "topDeveloperPartnership", suffix: "+", abbrK: false },
];
          ...
          <div className="grid grid-cols-1 gap-8 text-center text-white md:grid-cols-4 md:divide-x md:divide-white/20">
            {STATS.map((s, i) => (
              <div key={`${s.label}-${i}`} className="px-2">
                <div className="text-[35px] md:text-[40px] lg:text-[45px] font-normal leading-none tracking-wide stats-outline-number">
