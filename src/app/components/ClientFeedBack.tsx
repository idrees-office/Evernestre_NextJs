            ...
            {testimonials.length > 0 ? (
              <div className="relative" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
                {testimonials.length > slidesToShow && (
                  ...
                  <button
                      onClick={prevSlide}
                      className="absolute -left-3 sm:-left-4 top-1/2 -translate-y-1/2 z-10 w-7 h-7 bg-white/95 backdrop-blur rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-all border border-[#8b5d3b]/30 cursor-pointer hover:scale-110 active:scale-95"
                      aria-label="Previous"
                    >
                      <ChevronLeft className="w-4 h-4 text-[#8b5d3b]" />
                    </button>
                    <button
                      onClick={nextSlide}
                      className="absolute -right-3 sm:-right-4 top-1/2 -translate-y-1/2 z-10 w-7 h-7 bg-white/95 backdrop-blur rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-all border border-[#8b5d3b]/30 cursor-pointer hover:scale-110 active:scale-95"
                      aria-label="Next"
                    >
                      <ChevronRight className="w-4 h-4 text-[#8b5d3b]" />
                    </button>
