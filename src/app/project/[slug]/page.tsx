...
//                   <input type="text" className="w-full px-4 py-3 text-sm border border-gray-200 rounded-sm focus:ring-2 focus:ring-[#c97a52]/20 focus:border-[#c97a52] transition-colors bg-gray-50" placeholder="Full Name *" />
//                   <input type="email" className="w-full px-4 py-3 text-sm border border-gray-200 rounded-sm focus:ring-2 focus:ring-[#c97a52]/20 focus:border-[#c97a52] transition-colors bg-gray-50" placeholder="Email *" />
//                   <input type="tel" className="w-full px-4 py-3 text-sm border border-gray-200 rounded-sm focus:ring-2 focus:ring-[#c97a52]/20 focus:border-[#c97a52] transition-colors bg-gray-50" placeholder="Phone *" />
//                   <textarea rows={3} className="w-full px-4 py-3 text-sm border border-gray-200 rounded-sm focus:ring-2 focus:ring-[#c97a52]/20 focus:border-[#c97a52] transition-colors resize-none bg-gray-50" placeholder="Message (Optional)"></textarea>
//                   <button type="submit" className="w-full bg-[#c97a52] text-white py-3 rounded-sm text-sm font-medium hover:bg-[#b56a42] transition-colors">
//                     Submit Inquiry
//                   </button>
//                 </form>
//               </div>
...
//               <img src={projectData.mainImage} alt={projectData.title} className="w-full h-full object-cover" />
...
//                 <div className="bg-gradient-to-r from-[#c97a52] to-[#a85f3b] p-4 text-white">
//                   <h3 className="text-sm font-medium">Get Complete Details</h3>
//                   <p className="text-white/70 text-xs mt-0.5">Our experts will assist you</p>
//                 </div>
//                 <div className="p-4">
//                   <form className="space-y-2.5">
//                     <input type="text" className="w-full px-3 py-2 text-sm border border-gray-200 rounded-sm focus:ring-1 focus:ring-[#c97a52] focus:border-[#c97a52] transition-colors" placeholder="Full Name *" />
//                     <input type="email" className="w-full px-3 py-2 text-sm border border-gray-200 rounded-sm focus:ring-1 focus:ring-[#c97a52] focus:border-[#c97a52] transition-colors" placeholder="Email *" />
//                     <input type="tel" className="w-full px-3 py-2 text-sm border border-gray-200 rounded-sm focus:ring-1 focus:ring-[#c97a52] focus:border-[#c97a52] transition-colors" placeholder="Phone *" />
//                     <textarea rows={2} className="w-full px-3 py-2 text-sm border border-gray-200 rounded-sm focus:ring-1 focus:ring-[#c97a52] focus:border-[#c97a52] transition-colors resize-none" placeholder="Message"></textarea>
//                     <button type="submit" className="w-full bg-[#c97a52] text-white py-2.5 rounded-sm text-sm font-medium hover:bg-[#b56a42] transition-colors">
//                       Submit Inquiry
//                     </button>
//                   </form>
//                 </div>
...
//               {/* Agent Card - Separate */}
//               <div className="bg-white rounded-sm shadow-lg border border-gray-100 overflow-hidden p-4">
...
//                     <h4 className="text-sm font-medium text-gray-900">Diyor Kasimov</h4>
//                     <p className="text-xs text-[#c97a52]">District Manager</p>
//                     <p className="text-xs text-gray-500">of F&C Properties</p>
//                   </div>
//                 </div>
...
//           <img src={projectData.gallery[activeGalleryImage]} alt={`Gallery ${activeGalleryImage + 1}`} className="w-full h-full object-cover" />
...
//             </button>
//             <img src={projectData.gallery[activeGalleryImage]} alt="Full view" className="max-w-[95vw] max-h-[90vh] object-contain" onClick={(e) => e.stopPropagation()} />
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-16 lg:self-start space-y-3">
              ...
              <div className="bg-white rounded-sm shadow-lg border border-gray-100 overflow-hidden p-4">
                <div className="flex items-center gap-3">
                  <div className="relative w-16 h-16 rounded-sm overflow-hidden bg-gray-100 flex-shrink-0">
                    <Image 
                      src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80" 
                      alt="Agent" 
                      fill
