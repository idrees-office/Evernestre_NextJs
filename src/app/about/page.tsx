...
export default function AboutUs() {
  return (
    <div className="min-h-screen bg-[#faf8f5]">
      ...
      {/* <section className="relative bg-gradient-to-b from-[#1a1a1a] to-[#2d2d2d] py-16 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-[#d5a86e] to-transparent" />
          <div className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-[#d5a86e] to-transparent" />
        </div>
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            <span className="inline-block text-[#d5a86e] text-xs uppercase tracking-[0.3em] mb-4">About Evernest</span>
            <h1 className="text-2xl md:text-3xl font-light text-white mb-4 tracking-wide">
              Our Journey of Excellence
            </h1>
            <div className="w-16 h-px bg-gradient-to-r from-transparent via-[#d5a86e] to-transparent mx-auto mb-4" />
            <p className="text-gray-400 text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
              For over a decade, we have been helping clients navigate Dubai&apos;s dynamic real estate market 
              with commitment to excellence and deep local expertise.
            </p>
          </motion.div>
        </div>
      </section> */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600 text-[14px] leading-[1.8]">
                ...
                <p>
                  We&apos;ve witnessed Dubai&apos;s incredible transformation firsthand and have been 
                  instrumental in helping thousands of clients find their perfect properties—from 
                  luxury waterfront apartments to family-friendly villas.
                </p>
                <p>
                  Today, we continue to innovate while staying true to our core values of 
                  transparency, expertise, and client-centric service.
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              transition={{ duration: 0.7 }}
            >
              <span className="text-[#d5a86e] text-xs uppercase tracking-[0.2em]">What We Do</span>
              <h2 className="text-2xl md:text-3xl font-light text-white mt-2 mb-4">
                Mission
              </h2>
              <div className="w-12 h-px bg-[#d5a86e] mb-5" />
              <p className="text-gray-400 text-[14px] leading-[1.9] mb-4">
                At <span className="text-[#d5a86e]">Evernest Real Estate</span>, our mission is to realize our vision through hard work, optimism, and focus 
                on the end product. Our commitment lies in providing astute and efficient communication while enhancing 
                the real estate industry and our clients&apos; experiences.
              </p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.7, delay: 0.2 }}
            >
              <span className="text-[#d5a86e] text-xs uppercase tracking-[0.2em]">What We Stand For</span>
              <h2 className="text-2xl md:text-3xl font-light text-white mt-2 mb-4">
                Values
              </h2>
              <div className="w-12 h-px bg-[#d5a86e] mb-5" />
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <motion.div 
              ...
              transition={{ duration: 0.7 }}
            >
              <span className="text-[#d5a86e] text-xs uppercase tracking-[0.2em]">How We Work</span>
              ...
              <div className="space-y-4 text-gray-600 text-[14px] leading-[1.8]">
                <p>
                  Greetings from Evernest Real Estate, where we are committed to transforming your real estate 
                  aspirations into reality. Established in 2019, Evernest has swiftly emerged as a distinguished 
                  leader in Dubai&apos;s dynamic real estate landscape.
                </p>
                <p>
                  Our team combines deep market knowledge with personalized service, ensuring every client 
                  receives tailored solutions that align with their unique goals and aspirations.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="bg-[#8b5d3b] h-25 rounded flex items-center justify-center p-2 shadow">
                  <p className="text-white text-[10px] text-center font-medium uppercase tracking-wider ">Expert Guidance</p>
                </div>
                <div className="bg-[#e8e0d8] h-25 rounded" />
                <div className="bg-[#8b5d3b] h-25 rounded flex items-center justify-center p-2 shadow">
                  <p className="text-white text-[10px] text-center font-medium uppercase tracking-wider ">Investment</p>
                </div>
                <div className="bg-[#e8e0d8] h-25 rounded" />
                <div className="bg-[#8b5d3b] h-25 rounded flex items-center justify-center p-2 shadow">
                  <p className="text-white text-[10px] text-center font-medium uppercase tracking-wider">Trust</p>
                </div>
              </div>
            </motion.div>
          </div>
