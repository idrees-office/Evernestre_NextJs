...
// function formatMoney(amountString: string, currency: Currency) {
//   if (!amountString) return "Price on Request";

//   const numeric = parseFloat(amountString.replace(/[^\d.]/g, ""));
...
//           console.log("Off-Plan Projects Data:", res);
...
//             className="inline-flex h-9 items-center border border-[#c9a882] px-4 rounded-full text-sm text-[#8b5d3b] hover:bg-[#c9a882]/10"
//           >
...
//                       <span className="ml-2">{p.type || "Apartment"}</span>
//                     </div>
//                     <div className="flex items-center">
//                       <BedDouble className="h-5 w-5 text-[#8b5d3b]" />
//                       <span className="ml-2">{p.bedrooms_raw || "Studio"}</span>
//                     </div>
//                     <div className="flex items-center">
//                       <Bath className="h-5 w-5 text-[#8b5d3b]" />
//                       <span className="ml-2">{p.bathrooms || "—"}</span>
//                     </div>
...
//                           e.stopPropagation();
//                         }}
//                         className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#d0845d]/40 text-[#8b5d3b] hover:bg-[#d0845d]/10 cursor-pointer"
//                         aria-label="Call"
//                       >
...
type OffPlanProjectsProps = {
  projects: any[];  // we use any because you requested "no strict types"
};
            ...
            >
              <Link href={`/off-plan-projects/${p.slug}`}>
                ...
                <div className="p-2">
                  ...
                  <div className="mt-2 flex items-center justify-between border-t border-[#d0845b]/10 pt-2">
                    <div className="flex items-center gap-2">
                      <button className="flex h-8 w-8 items-center justify-center rounded-full border border-[#d0845d]/40 text-[#8b5d3b] hover:bg-[#d0845d]/10">
                        <Phone className="h-3.5 w-3.5" />
                      </button>
                      <button className="flex h-8 w-8 items-center justify-center rounded-full border border-[#d0845d]/40 text-[#8b5d3b] hover:bg-[#d0845d]/10">
                        <MessageCircle className="h-3.5 w-3.5" />
