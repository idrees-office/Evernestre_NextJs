...
type Project = {
  ...
  city: string;
  image: string;
  priceAED: number; // base price stored in AED
        ...
        <div className="mb-8 md:mb-8 flex items-start justify-between gap-6">
          <div>
            ...
            <p className="text-[#1a1a1a]/70 text-sm">
              Explore The UAE&apos;s Latest Off-Plan Projects By Top Developers, Representing A
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div key={p.slug} className="group relative overflow-hidden rounded-lg border border-[#d0845b]/20 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:-translate-y-1">
                ...
                <div className="relative h-48 w-full overflow-hidden">
                    <img src={p.image} alt={p.title} className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" draggable={false} />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                    <div className="absolute top-4 left-4 rounded-full bg-white/95 px-3 py-1.5 shadow-lg">
                    <div className="text-sm font-normal text-[#c2754e]"> {p.displayPrice} </div>
                    </div>
                </div>
                <div className="p-2">
                    <div className="mb-2">
