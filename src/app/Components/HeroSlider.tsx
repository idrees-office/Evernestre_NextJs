...
export default function HeroSlider({ hero }: HeroSliderProps) {
  ...
  useEffect(() => {
    ...
    const formatted: Slide[] = hero.slice(0, 5).map((p: Property) => ({
      image: p.banner,
      title: p.title ? p.title.slice(0, 35) : "",
    ...
    >
      ...
      <div
        className="
          ...
          cursor-pointer
          md:left-4 lg:left-8 xl:left-12 2xl:left-16
        "
      ...
      >
        <motion.div
          ...
          className="
            relative w-full
            max-w-[92vw] sm:max-w-md md:max-w-lg lg:max-w-xl
            mx-auto md:mx-0
          "
        >
          {/* Background container */}
          <motion.div
            ...
            className="
              ...
              -left-0 sm:-left-2 md:-left-8
              bg-gradient-to-r from-white/10 to-white/5 md:from-white/8 md:to-white/3
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <motion.span
                ...
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.5, delay: 0.9 }}
                className="text-[10px] sm:text-xs text-white/95 font-medium tracking-widest uppercase bg-gradient-to-r from-white/15 to-white/10 backdrop-blur-lg px-2 py-1 md:px-3 md:py-1.5 rounded-full border border-white/20"
              >
                {slides[current].type}
              </motion.span>
            </motion.div>
            ...
            <motion.h1
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal text-white mb-4 md:mb-6 tracking-tight leading-tight break-words"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.7 }}
            >
            ...
            >
              ...
              >
                ...
                <span className="text-sm sm:text-base font-normal tracking-wide truncate max-w-[70vw] sm:max-w-none">
                  {slides[current].subtitle}
                </span>
              </motion.div>
            </motion.div>
            ...
            >
              <motion.span
                ...
                animate={{ opacity: 1 }}
                transition={{ duration: 0.6, delay: 1.2 }}
                className="text-[10px] sm:text-xs text-white/80 font-light tracking-widest uppercase block bg-gradient-to-r from-white/12 to-white/8 backdrop-blur-lg px-3 py-1.5 rounded-full border border-white/15 inline-block"
              >
                Starting Price
              </motion.span>
